function [cv,pv,I_veins,flag_pv]=liv_vein_detection(imax,markers,thred,TIC_norm,sigma,vein_size_min,md,confid)
metadata=imax(:,1:2);
TIC=imax(:,3);
I0=idata2imgdata(imax(:,0+3),metadata)/mean(TIC); %get TIC
I1=idata2imgdata(imax(:,markers(1)+3),metadata); % get marker images
I2=idata2imgdata(imax(:,markers(2)+3),metadata);
I3=idata2imgdata(imax(:,markers(3)+3),metadata);
if TIC_norm==1
...
I1=log10(I1+eps);
I1=I1/max(max(I1));
I1=I1-mean(mean(I1,'omitnan'),'omitnan')+0.67; %recenter
I1(I1<0)=0;
%I1=I1/prctile(I1(:),99);

I2=log10(I2+eps);
I2=I2/max(max(I2));
I2=I2-mean(mean(I2,'omitnan'),'omitnan')+0.65; %recenter
I2(I2<0)=0;
%I2=I2/prctile(I2(:),99);

I3=log10(I3+eps);
I3=I3/max(max(I3));
I3=I3-mean(mean(I3,'omitnan'),'omitnan')+0.93; %recenter
I3(I3<0)=0;
%I3=I3/prctile(I3(:),99);

% marker 1, green 2, red
BW1 = imbinarize(I1,thred(1));
BW2 = imbinarize(I2,thred(2));
BW3 = imbinarize(I3,thred(3));
